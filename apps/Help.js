    ...
    const helpList = [
      ...
      },
      {
        ...
        list: [
          ...
          {
            icon: 13,
            title: '#exloli设置bing风格<风格名称>',
            desc: '修改使用的 Bing 风格'
          },
          {
            icon: 14,
            title: '#exloli设置v1模型<模型名称>',
            desc: '修改 Prodia V1 使用的模型'
          },
          {
            icon: 15,
            title: '#exloli设置v1步数<步数>',
            desc: '修改 Prodia V1 绘制步数'
          },
          {
            icon: 16,
            title: '#exloli设置v1相关性<值>',
            desc: '修改 Prodia V1 提示词相关性'
          },
          {
            icon: 17,
            title: '#exloli设置v1采样<采样器>',
            desc: '修改 Prodia V1 采样器'
          },
          {
            icon: 18,
            title: '#exloli设置v1负面<提示词>',
            desc: '修改 Prodia V1 负面提示词'
          },
          {
            icon: 19,
            title: '#exloli设置sd模型<模型名称>',
            desc: '修改 Prodia SD 使用的模型'
          },
          {
            icon: 20,
            title: '#exloli设置sd宽度<值>',
            desc: '修改 Prodia SD 画幅宽度'
          },
          {
            icon: 21,
            title: '#exloli设置sd高度<值>',
            desc: '修改 Prodia SD 画幅高度'
          },
          {
            icon: 22,
            title: '#exloli设置sd步数<步数>',
            desc: '修改 Prodia SD 绘制步数'
          },
          {
            icon: 23,
            title: '#exloli设置sd相关性<值>',
            desc: '修改 Prodia SD 提示词相关性'
          },
          {
            icon: 24,
            title: '#exloli设置sd采样<采样器>',
            desc: '修改 Prodia SD 采样器'
          },
          {
            icon: 25,
            title: '#exloli设置sd负面<提示词>',
            desc: '修改 Prodia SD 负面提示词'
          },
          {
            icon: 26,
            title: '#exloli设置xl模型<模型名称>',
            desc: '修改 Prodia XL 使用的模型'
          },
          {
            icon: 27,
            title: '#exloli设置xl宽度<值>',
            desc: '修改 Prodia XL 画幅宽度'
          },
          {
            icon: 28,
            title: '#exloli设置xl高度<值>',
            desc: '修改 Prodia XL 画幅高度'
          },
          {
            icon: 29,
            title: '#exloli设置xl步数<步数>',
            desc: '修改 Prodia XL 绘制步数'
          },
          {
            icon: 30,
            title: '#exloli设置xl相关性<值>',
            desc: '修改 Prodia XL 提示词相关性'
          },
          {
            icon: 31,
            title: '#exloli设置xl采样<采样器>',
            desc: '修改 Prodia XL 采样器'
          },
          {
            icon: 32,
            title: '#exloli设置xl负面<提示词>',
            desc: '修改 Prodia XL 负面提示词'
          },
          {
            icon: 33,
            title: '#exloli设置pa宽度<值>',
            desc: '修改 Pixart A 画幅宽度'
          },
          {
            icon: 34,
            title: '#exloli设置pa高度<值>',
            desc: '修改 Pixart A 画幅高度'
          },
          {
            icon: 35,
            title: '#exloli设置pa相关性<值>',
